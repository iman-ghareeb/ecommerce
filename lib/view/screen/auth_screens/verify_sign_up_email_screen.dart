import 'package:ecommerce/controller/auth/email_Signup_verify_controller.dart';
...
class EmailVerifcationSignUpScreen extends StatelessWidget {
  EmailVerifcationSignUpScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    EmailVerifcationSignUpControllerImp controller = Get.put(EmailVerifcationSignUpControllerImp());
    return Scaffold(
        appBar: AppBar(),
        body: WillPopScope(
          onWillPop: ()=> goOutApp(),
